...
## Project Description:
This project is an implementation of the WireWorld Cellular Automata. For more information on what Cellular Automata is and why it's so cool, feel free to check out this (https://www.google.com "WireWorld Repository"). The project was put together with the use of Unity 3D. 
